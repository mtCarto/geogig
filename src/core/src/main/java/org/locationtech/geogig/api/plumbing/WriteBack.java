    ...
    private ObjectId writeBack(final RevTree root, final String ancestorPath,
        ...
        if (isDirectChild) {
            ...
            Node treeNode = Node.create(childName, childTree.getId(), metadataId, TYPE.TREE,
                    treeBounds);
            RevTree newRoot;
            TreeBuilder ancestor = new RevTreeBuilder(targetDatabase, root);
            ...
            if (parentRef.isPresent()) {
                ...
                parentBuilder = new RevTreeBuilder(targetDatabase, targetDatabase.getTree(parentId));
            } else {
                parentBuilder = new RevTreeBuilder(targetDatabase);
            }
