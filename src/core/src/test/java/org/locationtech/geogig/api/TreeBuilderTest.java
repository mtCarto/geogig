...
public abstract class TreeBuilderTest {

    protected ObjectStore objectStore;

    protected abstract TreeBuilder createBuiler();
    ...
    private void testResultingTreeSize(int numEntries) {
        ...
        objectStore.open();
        TreeBuilder builder = createTree(numEntries, true);
    ...
    public void testPutRandomGet() throws Exception {
...

        {
            ...
            TreeBuilder mutable = createBuiler(tree);
    ...
    public void testUpdateSplittedTree() throws Exception {
        ...
        TreeBuilder builder = createBuiler(tree);
    ...
    protected ObjectId createAndSaveTree(final int numEntries,
        ...
        TreeBuilder treeBuilder = createTree(numEntries, insertInAscendingKeyOrder);
    ...
    private TreeBuilder createTree(final int numEntries, final boolean insertInAscendingKeyOrder) {
        TreeBuilder tree = createBuiler();
    ...
    private void addNode(TreeBuilder tree, int i) {
    ...
    public void testBuildWithChildTreesUnsplittedRoot() {
        ...
        TreeBuilder builder = createTree(rootFeatureCount, false);
    ...
    private TreeBuilder tree(int nfeatures) {
        TreeBuilder b = createBuiler();
