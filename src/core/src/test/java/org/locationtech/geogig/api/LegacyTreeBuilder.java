...
public class LegacyTreeBuilder implements TreeBuilder {

    private static final Logger LOGGER = LoggerFactory.getLogger(LegacyTreeBuilder.class);
    ...
    private static final int NORMALIZED_SIZE_LIMIT = 512;
    ...
    public LegacyTreeBuilder normalizationThreshold(final int threshold) {
    ...
    private RevTree normalizeToBuckets() {
        ...
        if (initialSize > NORMALIZED_SIZE_LIMIT) {
            accSize += initialSize;
        }
     ...
     * @return a reference to this {@link org.locationtech.geogig.api.LegacyTreeBuilder
     *         RevTreeBuilder}
     */
    public LegacyTreeBuilder put(final Node node) {
     ...
     * @return {@code this}
     */
    public LegacyTreeBuilder remove(final String childName) {
     ...
     * @return {@code this}
     */
    public LegacyTreeBuilder clearSubtrees() {
